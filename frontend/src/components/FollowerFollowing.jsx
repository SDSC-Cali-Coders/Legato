  ...
  return (
    <div className="container mt-4 px-4 d-grid gap-3 Oswald_regular">
      ...
      <div className="row mb-3">
        <div
          className="btn-group col-7 px-0"
          role="group"
        ...
        >
          <input
            ...
            defaultChecked
            onChange={() => {
              props.setFollowSelector("follower");
            }}
          />
          <label
            htmlFor="selectorFollower"
            className="btn btn-secondary fw-bold mx-3"
          >
            Followers
          </label>
          <input
            ...
            className="btn-check px-0"
            name="followSelector"
            id="selectorFollowing"
            autoComplete="off"
            onChange={() => {
              props.setFollowSelector("following");
            }}
          />
          <label
            htmlFor="selectorFollowing"
            className="btn btn-secondary fw-bold mx-3"
          >
            Following
          </label>
