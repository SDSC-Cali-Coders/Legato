...
const SettingsScript = () => {
  ...
  if (responseData) {
    settingsObj = {
      ...
      topArtistsList: [
        {
          artistImg: responseData.topArtists[0].images[0].url,
          artistName: responseData.topArtists[0].name,
        },
        {
          artistImg: responseData.topArtists[1].images[0].url,
          artistName: responseData.topArtists[1].name,
        },
        {
          artistImg: responseData.topArtists[2].images[0].url,
          artistName: responseData.topArtists[2].name,
        },
        {
          artistImg: responseData.topArtists[3].images[0].url,
          artistName: responseData.topArtists[3].name,
        },
        {
          artistImg: responseData.topArtists[4].images[0].url,
          artistName: responseData.topArtists[4].name,
        },
      ],
      topSongsList: [
        {
          songTitle: responseData.topSongs[0].name,
          artistName: responseData.topSongs[0].artists[0].name,
        },
        {
          songTitle: responseData.topSongs[1].name,
          artistName: responseData.topSongs[1].artists[0].name,
        },
        {
          songTitle: responseData.topSongs[2].name,
          artistName: responseData.topSongs[2].artists[0].name,
        },
        {
          songTitle: responseData.topSongs[3].name,
          artistName: responseData.topSongs[3].artists[0].name,
        },
        {
          songTitle: responseData.topSongs[4].name,
          artistName: responseData.topSongs[4].artists[0].name,
        },
      ],
      topGenreList: [
