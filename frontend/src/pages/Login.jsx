...
export default function Login() {
    return (
        ...
        */}
            <section id="demo">
                <div id="carouselExampleIndicators" class="carousel slide relative-bottom bg-neutral-light" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block mw-75 h-auto m-auto" src={pic1} alt="First slide (Listening History)"/>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-40 m-auto" src={pic2} alt="Second slide (Cocerts)"/>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-40 m-auto" src={pic3} alt="Third slide (Artist Description)"/>
                        </div>
                    </div>
